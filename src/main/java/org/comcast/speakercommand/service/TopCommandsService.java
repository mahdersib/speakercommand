...
@Service
public class TopCommandsService {
    ...
    public List<String> getTopCommandsNationally(List<StateCommands> stateCommands){
        ...
        List<String>  topThreeCommands = allCommands.stream().collect(Collectors.groupingBy(command -> command.getCommand().toLowerCase(), Collectors.counting()))
